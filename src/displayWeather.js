...
const displayWeather = (data) => {
  ...
  getElement(
    '.min'
  ).innerHTML = `<i class="fas fa-temperature-low"></i> min:${min}&deg;C`;
  getElement(
    '.max'
  ).innerHTML = `<i class="fas fa-temperature-high"></i> max:${max}&deg;C`;
  getElement(
    '.humidity'
  ).innerHTML = ` <i class="fas fa-tint"></i>Humidity: ${humidity}%`;
  getElement(
    '.pressure'
  ).innerHTML = ` <i class="fas fa-long-arrow-alt-down"></i>${pressure}hPa`;
  getElement('.wind').innerHTML = `<i class="fas fa-wind"></i>${
